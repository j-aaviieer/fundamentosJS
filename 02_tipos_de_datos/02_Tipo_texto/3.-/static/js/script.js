...
// hecho por Javier Colque

function edadProyectada() {
    let edad= 16;
    alert(`Mi edad es ${edad}
        \nEn 5 años voy a tener: ${edad + 5}
        \nHace 10 años mi edad era: ${edad - 10}`); //Alerta en pantalla
};
...
function compraDescuento() {
    ...
    alert(`El precio fijo del producto es: ${producto} y tiene un descuento de 20% ,
        \nEl precio del producto con el descuento sera de: ${producto - (producto * descuento)} `)
};
